...
저는 국립농업과학원에서 재직하며 다른 도메인에서도 연구 책임자의 목표 달성을 지원한 경험이 있습니다. 또한, 공식적인 연구 과제 외에도 전공자와 대화를 통해 얻은 아이디어를 실제로 구현해보고자, 농업과학원에서 축적한 데이터를 활용하여 농업 분야에 특화된 AI 모델을 개발하는 개인 연구를 진행하고 있습니다.
