...
(최소 700자, 최대 1,000자 입력가능)
 ...
 LIG 넥스원을 NASA로 만들겠다. NASA의 기술은 최첨단이지만 우주항공로켓 개발체에 국한되지 않는다. 믹서기, 담요 등등, 무기체계는 엄격한 정밀함을 목표로 한다. 이런 기술은 근데 또 일상 산업에 못쓰냐? 그런 건 아닐 거거든, 이미 적용되는 기술이 있기도 하겠지만, 그런 기술들을 개발하고, 이전하고 응용할 수 있는 기술을 개발하여 자주국방을 위한 기술과 더불어 산업 확장을 도모할 수 있도록 기여하겠다.
